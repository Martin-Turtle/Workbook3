...
public class MinMaxDouble {
    public static void main(String[] args) {
        ...
        // call the method
        // determine if the variables are whole numbers or decimal numbers
        // 10 % 1 = 0 => 10 is whole number
        if ( number1 % 1 == 0 && number2 % 1 == 0 && number3 % 1 == 0)
        {
            System.out.println("The biggest number is " + maxNumberA((int) number1, (int) number2, (int) number3));
            System.out.println("The smallest number is " + minNumberA((int) number1, (int) number2,(int) number3));
        }
        else {
    ...
    static int maxNumberA(int a, int b, int c){
        if ( a > b && a > c) {
            return a;
        } else if ( b > a && b > c) {
            return b;
    ...
    static int minNumberA(int a, int b, int c){
        if ( a < b && a < c) {
            return a;
        } else if ( b < a && b < c) {
            return b;
